...
public class ug_department extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ug_department);
        setTitle("Under Graduate");
        ...
        _progressBarUG = findViewById(R.id.progressBarUG);
        ...
        public void onClick (View v){
            if (v == _view) {
                ...
                String radio = ((RadioButton) findViewById(_year.getCheckedRadioButtonId()))
                        .getText().toString();
                Intent intent = new Intent(ug_department.this, ugdsp.class);
